...
GameCompass is a local-first game discovery desk for exploring genres, systems, and upcoming releases. It starts clean: no personal profile, library, or playtime data is bundled. On first launch, you create your own profile.
...
1. Release bölümünden `Oyun Pusulasi.exe` dosyasını indir.
2. Uygulamayı aç ve **Yeni profil oluştur** düğmesine bas.
3. Sevdiğin türleri ve önermemem gereken oyun tiplerini yaz.
4. Kütüphaneni istersen sonradan Steam Web API veya dosya aktarımıyla ekle.
...
- Six themes, six fonts, and local caching for a faster start.

### Getting started

1. Download `Oyun Pusulasi.exe` from the Releases page.
2. Open the app and choose **Yeni profil oluştur** / **Create a new profile**.
3. Describe the genres and game types you enjoy or want to avoid.
4. Optionally import your library later through Steam Web API or a file.
